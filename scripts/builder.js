...
if (fs.existsSync("nativescript-theme-christmas")) {
    deleteFolderRecursive("nativescript-theme-christmas");
}
fs.mkdirSync("nativescript-theme-christmas");
fs.mkdirSync("nativescript-theme-christmas/css");
fs.mkdirSync("nativescript-theme-christmas/scss");
fs.mkdirSync("nativescript-theme-christmas/fonts");
...
// Copy our Package
copyFile("./nativescript-theme-christmas.json", "./nativescript-theme-christmas/package.json");

// Copy our Readme
copyFile("./nativescript-theme-christmas.md", "./nativescript-theme-christmas/readme.md");

console.log("Change to the 'nativescript-theme-christmas' folder and you can now do your `npm publish`");
...
function copyFonts() {
    ...
    for (i = 0; i < ttfFiles.length; i++) {
        out = ttfFiles[i].replace("./app/", "./nativescript-theme-christmas/");
        // Skip font Awesome
    ...
    for (i = 0; i < otfFiles.length; i++) {
        out = otfFiles[i].replace("./app/", "./nativescript-theme-christmas/");
        // Skip font Awesome
        if (out.indexOf("fontawesome") !== -1) {
            continue;
        }
...
function copySCSS() {
    ...
    for (var i = 0; i < sassFiles.length; i++) {
        var out = sassFiles[i].replace("./app/", "./nativescript-theme-christmas/");
        ...
        if (paths.length > 1) {
            var path = "./nativescript-theme-christmas";
...
function parseSass(sassFile, importPaths) {
    ...
    var outputFile = "nativescript-theme-christmas/css";
